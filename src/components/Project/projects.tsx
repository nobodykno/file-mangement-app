...
const Projects = () => {
  ...
  const [createForm, setCreateForm] = useState<ICreateProjectModel>({
    name: "",
    description: "",
  });
  const [createErrors, setCreateErrors] = useState<ICreateProjectModel>({
    name: "",
    description: "",
  });
  ...
  const [editForm, setEditForm] = useState<ICreateProjectModel>({
    name: "",
    description: "",
  });
  const [editErrors, setEditErrors] = useState<ICreateProjectModel>({
    name: "",
    description: "",
  });
        ...
        <div className="create_form">
          ...
          <div className="form_field">
            ...
            {editErrors.description && (
              <p className="error_msg">{editErrors.description}</p>
            )}
          </div>
